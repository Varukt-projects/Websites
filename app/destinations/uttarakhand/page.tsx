...
const destination = destinations.uttarakhand

export const metadata = {
  title: `${destination.name} | Travel Your Journey - Spiritual & Adventure Retreats`,
  description: destination.longDescription,
  openGraph: {
    title: `Explore ${destination.name} - Yoga & Adventure in the Himalayas`,
    description: destination.longDescription,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-gradient-to-r from-primary to-accent rounded-lg p-8 md:p-12 text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://wa.me/917434829124?text=Hi%2C%20I%27d%20like%20to%20plan%20a%20trip%20to%20Uttarakhand"
              target="_blank"
