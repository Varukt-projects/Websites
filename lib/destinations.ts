...
export const destinations: Record<string, Destination> = {
  ...
  goa: {
    ...
    longDescription:
      "Goa, a former Portuguese colony, is a unique blend of Indian and Western cultures. With its pristine beaches, backwater cruises, spice plantations, and vibrant coastal towns, Goa offers a perfect mix of relaxation, adventure, and cultural exploration. Experience the laid-back vibe, delicious seafood, and warm hospitality of Goa.",
    bestTime: "November to February",
    altitude: "0 - 1,000 meters",
    image: "/goa-beach-coconut-trees-landscape.jpg",
    highlights: ["Anjuna Beach", "Palolem Beach", "Spice Plantations", "Backwaters", "Fort Aguada"],
    activities: [
      {
      ...
      },
      {
        ...
        description: "Explore scenic backwaters and coconut plantations",
        duration: "Half day",
        difficulty: "Easy",
      },
      {
        name: "Water Sports",
        description: "Parasailing, jet skiing, and windsurfing",
        duration: "Half day",
        difficulty: "Moderate",
      },
      {
        name: "Cultural Heritage",
        description: "Visit churches, temples, and historic forts",
        duration: "Half day",
        difficulty: "Easy",
      },
    ],
    accommodations: [
      {
        ...
        priceRange: "₹10,000 - ₹18,000/night",
        amenities: ["Beach Access", "Water Sports", "Spa", "Fine Dining"],
      },
      {
        name: "Boutique Hotel",
        type: "Hotel",
        description: "Charming boutique hotel in heritage area",
        priceRange: "₹6,000 - ₹12,000/night",
        amenities: ["Local Cuisine", "Art Gallery", "Garden", "WiFi"],
      },
      {
        name: "Beach Shack",
        type: "Guesthouse",
        description: "Casual beachfront accommodation",
        priceRange: "₹2,000 - ₹6,000/night",
        amenities: ["Beach Access", "Restaurant", "Relaxed Vibe", "Budget Friendly"],
      },
    ],
    packages: [
      {
        ...
        highlights: ["Beaches", "Water Sports", "Local Markets", "Nightlife"],
      },
      {
        name: "Backwater & Spice Tour",
        duration: "3 days",
        price: "₹32,000 per person",
        highlights: ["Backwater Cruise", "Spice Plantation", "Local Culture", "Seafood"],
      },
      {
        name: "Heritage & Beach Escape",
        duration: "4 days",
        price: "₹40,000 per person",
        highlights: ["Fort Aguada", "Churches", "Beaches", "Portuguese Heritage"],
      },
    ],
  },
}
